...
subject: `{{ admin_name }} accepted your request to join {{ organization }}`

body:
`
<h1>Hi {{name}}!</h1>
<p>{{admin_name}} accepted your request to join {{organization}}. Click the button below to setup your account:</p>
<!-- Action -->
