...
export default function Contact() {
  ...
  useEffect(() => {
    setActionURL(import.meta.env.VITE_REACT_APP_INTEGRATIONS_CONTACT_FORMSPREE?.toString() ?? "");
  }, []);
        ...
        <div className="bg-white dark:bg-gray-900">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="sm:flex sm:flex-col sm:align-center">
              <div className="relative max-w-xl mx-auto py-12 sm:py-6 w-full overflow-hidden">
                ...
                <div className="mt-12">
                  {!actionURL && <WarningBanner title={t("shared.notSet")} text={t("front.contact.setup")} />}
                  <form action={actionURL} method="POST" className="mt-9 grid grid-cols-1 gap-y-6 sm:grid-cols-2 sm:gap-x-8">
                    <div>
